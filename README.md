# [DEPRECATED] Recurly Source dbt package

> _This package has been archived and is no longer maintained. Use [`dbt_recurly`](https://github.com/fivetran/dbt_recurly) instead, which now contains all models previously found here._
